...
| `~/betfair-nlp-local-ci-e2e` | `local-ci-e2e-tests` | Local CI e2e tests | exists per `git worktree list`, not previously listed here — status/owner unknown, check before touching |
