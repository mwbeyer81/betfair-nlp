...
**Not yet merged/deployed/live** — the guardrails above exist and are verified, but production's `BETFAIR_DRY_RUN`/`BETFAIR_LIVE_BETTING_ALLOWED_EMAIL` env vars haven't been touched yet; see whether a further dated entry below confirms that happened.
