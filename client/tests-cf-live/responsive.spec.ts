...
test.describe("CF /runners — iPhone 375px", () => {
  test.use({ viewport: MOBILE });

  test.beforeEach(async ({ page }) => {
    await page.goto(`/runners${AUTH}`);
  ...
  test("filter bar fits within 375px", async ({ page }) => {
...
test.describe("CF /runners — tablet 768px", () => {
  ...
  test("header buttons and filter apply visible", async ({ page }) => {
...
test.describe("CF /runners — desktop 1280px", () => {
...
test.describe("CF /events — iPhone 375px", () => {
  test.use({ viewport: MOBILE });

  test.beforeEach(async ({ page }) => {
    await page.goto(`/events${AUTH}`);
  ...
  test("header buttons within 375px", async ({ page }) => {
